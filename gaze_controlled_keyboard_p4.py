...
def get_gaze_ratio(eye_points, facial_landmarks):
    ...
    height, width, _ = frame.shape
     #create the mask to extract xactly the inside of the left eye 
    ...
    # We see which area has more white color by counting zeros
    # The area having more zeros is white else black
    left_side_white = cv2.countNonZero(left_side_threshold)
    # We see right and left side white to detect if eyes are not at center
