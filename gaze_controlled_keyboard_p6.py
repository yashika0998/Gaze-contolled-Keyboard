...
def letter(letter_index, text, letter_light):
    ...
    if letter_light is True:
        ...
        # -1 means --> color the rectangle   # 255,255,255 is for white color
    else:
...
# Finally we can display all the letters looping 
# through the dictionary we created before, 
# containing the keys of left side of the keyboard.
for i in range(15):
    if i == 5:
        light = True
    else:
