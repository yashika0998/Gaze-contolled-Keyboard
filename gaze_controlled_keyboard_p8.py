...
# New white board where text will be typed
...
while True:
    ...
    # Select letter only when blinking for a longer time
    ...
    for face in faces:
        ...
        if blinking_ratio > 5.7:
            ...
            blinking_frames += 1
            # when we have eyes closed the frame detection is closed, hence letter doesn't change
            frames -= 1
    ...
    #Finally we display the text on the board.(10,100)-> position
    # 4--> font scale; 0--> color as black; 3-->thickness 
